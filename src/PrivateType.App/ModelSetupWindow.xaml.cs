...
public partial class ModelSetupWindow : Window
{
    ...
    public void ShowRuntimePrerequisite(string message)
    {
        HeadingText.Text = "Microsoft runtime required";
        ...
        ProgressCaption.Text = "The model will not download until the local runtime is ready.";
